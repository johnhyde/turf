  ...
  return (
    <div class='h-full overflow-y-auto'>
      <div class='m-1 p-4 space-y-4 bg-yellow-950 rounded-lg text-yellow-50'>
          ...
          <Switch>
            <Match when={tab() === 'tabs'}>
              <div>
                ...
                <ul class='list-disc list-inside'>
                  ...
                  <li>
                    Press Z to open the turf settings
                  </li>
                  <li>
                  ...
                  <li>
                    Press Escape to exit the current tab, close the sidebar, or
                    open the sidebar
                  </li>
                </ul>
              </div>
            ...
            <Match when={tab() === 'chat'}>
              <div>
                ...
                <ul class='list-disc list-inside'>
                  ...
                  <li>
                    In your own turf, you can kick people out with "/kick
                    ~sampel-palnet"
                  </li>
                  <li>
            ...
            <Match when={tab() === 'editor'}>
              <div>
                ...
                <ul class='list-disc list-inside'>
                  <li>
                    Click on an item see and edit its info
                  </li>
                  <li>
                  ...
                  <li>
                    Press I to use the eye dropper tool. Click on an item in the
                    turf to start placing more of it
                  </li>
                  <li>
                    Press Delete or Backspace to use the eraser tool. This lets
                    you remove items or kick players
                  </li>
                  <li>
                    Click on a tile or item sprite from the library to place it
                    in the world
                  </li>
                  <li>
                    Press Escape to return to the pointer tool (the default).
                    This tool lets you select objects and see their properties.
                  </li>
                </ul>
              </div>
            </Match>
              ...
              <div>
                ...
                <ol class='list-decimal list-inside'>
                  ...
                  {weAreHost
                    ? (
                      <li>
                        Approve or reject requests from planets/moons/comets to
                        place houses in your Town
                      </li>
                    )
                    : (
                      <>
                        <li>
                          Select a star to be your home Town. Most stars will
                          need to manually approve you, but ~pandux accepts all
                          requests automatically
                        </li>
                        <li>
                          In your home Town, Place House to create a portal back
                          to your turf
                        </li>
                      </>
                    )}
            ...
            <Match when={tab() === 'portals'}>
              <div>
                ...
                <ol class='list-decimal list-inside'>
                  ...
                  <li>
                    Press Enter or click the + button and place the portal on
                    the turf
                  </li>
                  <li>
            ...
            <Match when={tab() === 'events'}>
              <div>
                ...
                <ol class='list-decimal list-inside'>
                  ...
                  <li>
                    Add a name for the event and set how long it should last (in
                    minutes)
                  </li>
                  <li>
                    Click Create and use the copy button to copy the chat
                    command
                  </li>
                  <li>
                  ...
                  <li>
                    You can cancel your event in the portals tab with the X
                    button
                  </li>
                </ol>
              </div>
        ...
        <p>
          Turf is in Season 0: Beta Testing. Things might break from time to
          time, but everything you make will be preserved in future versions.
        </p>
        <p>
          You are currently opted{' '}
          {state.mist.config.enabled ? 'in to' : 'out of'}{' '}
          daily usage tracking. When enabled, Turf tells{' '}
          {state.mist.config.vitaParent} whether you used the app once per day.
        </p>
        <p>
